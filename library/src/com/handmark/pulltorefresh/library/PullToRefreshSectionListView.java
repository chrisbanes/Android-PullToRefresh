...
public class PullToRefreshSectionListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public ContextMenuInfo getContextMenuInfo() {
        return ((SectionListView) getRefreshableView()).getContextMenuInfo();
    }
    ...
    protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
        SectionListView lv = new SectionListView(context, attrs);
        lv.setPullToRefreshSectionListView(this);

        final int mode = this.getMode();

        // Loading View Strings
        String pullLabel = context.getString(com.handmark.pulltorefresh.library.R.string.pull_to_refresh_pull_label);
        String refreshingLabel = context
                .getString(com.handmark.pulltorefresh.library.R.string.pull_to_refresh_refreshing_label);
        String releaseLabel = context
                .getString(com.handmark.pulltorefresh.library.R.string.pull_to_refresh_release_label);
