...
public abstract class PullToRefreshBase<T extends AbsListView> extends LinearLayout implements OnTouchListener,
    ...
    /**
     * Removes the specified emptyView from layout, then adds it to `this`,
     * which is a LinearLayout. This only happens if the count of the adapterView is 0.
     *
     * @access public
    ...
    public void setEmptyView(View emptyView) {
        if (adapterView.getCount() == 0) {
            ViewGroup vg = (ViewGroup) emptyView.getParent();
            vg.removeView(emptyView);
